...
public class RegistroServiceImpl implements RegistroService {
    ...
    public Model activar(Model model, String username, String clave) {
        ...
        if (usuario != null) {
            ...
            model.addAttribute(
                    "titulo", 
                    messageSource.getMessage("registro.activar",null,  Locale.getDefault()));//Locale.getDefault() esto envia los mensaje segun el idioma en el que este el usuario
            model.addAttribute(
                    "mensaje", 
    ...
    //metodo al darle sunmit al activar
    @Override
